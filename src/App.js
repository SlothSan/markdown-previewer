...
![freeCodeCamp Logo](https://cdn.freecodecamp.org/testable-projects-fcc/images/fcc_secondary.svg)`
    ...
    const handleClickMaximisePreview = (event) => {
        event.preventDefault()
        event.stopPropagation()
        setPreviewMaximised(!previewMaximised)
    }
  ...
  return (
    <div className="App">
      <Editor handleClickMaximiseEditor={handleClickMaximiseEditor}
              ...
              previewMaximised={previewMaximised}
              markdownBody={markdownBody}
              setMarkdownBody={setMarkdownBody}/>
      <Previewer markdownBody={markdownBody}
                 editorMaximised={editorMaximised}
                 previewMaximised={previewMaximised}
                 handleClickMaximisePreview={handleClickMaximisePreview}/>
    </div>
  );
}
